  ...
  <body>
    ...
    <script>
      const CONFIGURATION = {
        ...
        "mapOptions": {"center":{"lat":37.5202145,"lng":-122.2758008},"fullscreenControl":true,"mapTypeControl":false,"streetViewControl":false,"zoom":15,"zoomControl":true,"maxZoom":20,"mapId":""},
        "mapsApiKey": "AIzaSyD1soUVTeNBZfwqO2yc48fShFqUPFvGvfk"
      };
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD1soUVTeNBZfwqO2yc48fShFqUPFvGvfk&callback=initMap&libraries=places,geometry&solution_channel=GMP_QB_commutes_v2_c" async defer></script>
  </body>
</html>